...
class Avatar implements Serializable
{
    ...
    // ====================== METHODES ====================== //
    // ====================================================== //
    // L'entité Avatar implémente Serializable elle doit donc contenir deux méthodes (même si on ne fait rien dedans)
    // la méthode serialize qui converti les propriétés non texte en texte, comme les images
    // et la méthode unserialize() qui converti des données texte en objets
