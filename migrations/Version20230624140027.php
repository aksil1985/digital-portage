 ...
 */
final class Version20230624140027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE talent ADD user_id INT DEFAULT NULL, ADD user_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE talent DROP user_id, DROP user_id_id');
    }
}
